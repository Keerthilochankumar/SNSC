      ...
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p className="mb-8 leading-relaxed">Are you a sports enthusiast who wants to keep up with the most recent reports, results, and evaluations from the sports world? If the answer is yes, you've found the proper site.</p> <a className='font-bold'> Welcome to SNSC</a>
